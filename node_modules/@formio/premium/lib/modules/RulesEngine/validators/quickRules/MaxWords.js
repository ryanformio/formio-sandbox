...
var MaxWordsQuickRule = /** @class */ (function (_super) {
    ...
    MaxWordsQuickRule.prototype.addRule = function (helper, input) {
        ...
        var wordsVariableKey = helper.makeVariableKeyUnique(_.camelCase(wordsVariableName));
        var wordsCountVariableName = 'Words Count';
        var wordsCountVariableKey = helper.makeVariableKeyUnique(_.camelCase(wordsCountVariableName));
        var conditionName = "Max Words " + maxWords;
        var conditionKey = helper.makeConditonKeyUnique(_.camelCase(conditionName));
        helper.addVariable({
